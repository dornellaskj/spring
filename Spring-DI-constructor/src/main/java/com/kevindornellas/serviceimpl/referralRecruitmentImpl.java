...
public class referralRecruitmentImpl implements RecruitmentService {
	...
	public String recruitEmployees(String companyName, String departmentName, int numberOfRecruitments) {
		...
		rand.nextInt(numberOfRecruitments) + " employees " + "which were referred to the company by employees.";
		return hiringFacts;
	}
